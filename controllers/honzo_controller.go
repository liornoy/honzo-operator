...
type HonzoReconciler struct {
	client.Client
	Scheme *runtime.Scheme
}

//+kubebuilder:rbac:groups=my.domain,resources=honzoes,verbs=get;list;watch;create;update;patch;delete
...
// the Honzo object against the actual cluster state, and then
...
func (r *HonzoReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&mydomainv1alpha1.Honzo{}).
		Complete(r)
}
